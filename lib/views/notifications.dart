...
import 'package:fitrack/view_models/notification.dart';
                  ...
                  if (snapshot.hasData) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final scheduledDate = DateTime.parse(doc['scheduledDate']);
                          ...
                          return SizedBox(
                            ...
                            child: Column(
                              children: [
                                ...
                                if (doc['type'] == 'water')
                                  NotificationsCard(
                                    icon: const Icon(Icons.water_drop, size: 35, color: FitColors.text20),
                                    text: doc['body'],
