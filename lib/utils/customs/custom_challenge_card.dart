                ...
                children: [
                    ...
                    child: RichText(
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: widget.challengeDate,
                            style: TextStyles.labelSmall.copyWith(color: FitColors.text20),
                          ),
                        ],
                      ),
                    ),
                  ...
                  if (widget.challengeJoined == true)
                    Container(
                      ...
                      child: Text(
                        "${widget.challengeProgress}",
                        style: TextStyles.labelMedium.copyWith(color: FitColors.text20),
                      ),
                    )
                ],
              ),
              Row(
                children: [
                  Container(
                    ...
                    child: Stack(
                      children: [
                        for (int i = 1; i <= widget.challengeParticipants && i <= widget.challengeParticipantsImg.length; i++, marginValue += 15)
                          Container(
                            margin: EdgeInsets.fromLTRB(marginValue, 0, 0, 0),
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(8.0),
                          ...
                          child: ElevatedButton(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  "Copy ID",
                                  style: TextStyles.bodyXSmall.copyWith(color: FitColors.text95),
                                ),
                                const Icon(
                                  Icons.copy,
                                  size: 15,
                        ...
                        if (widget.challengeJoined == false)
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(
                                "Join",
                                style: TextStyles.labelSmall.copyWith(color: FitColors.primary95),
                              ),
                            ),
                          ),
                        if (widget.challengeJoined == true)
